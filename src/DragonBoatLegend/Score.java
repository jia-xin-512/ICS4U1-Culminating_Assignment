...
public class Score implements Comparable<Score> {
    ...
    public Score(String name, int score) {
        ...
        this.score = score;  // Initialize the player's score
    }
     ...
     * @return A negative integer, zero, or a positive integer if this score 
     *         is greater than, equal to, or less than the other score
     */
    @Override
    public int compareTo(Score other) {
        return other.score - this.score;  // Sort scores in descending order
    }
}